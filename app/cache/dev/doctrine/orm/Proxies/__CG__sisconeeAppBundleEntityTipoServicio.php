 ...
 */
class TipoServicio extends \sisconee\AppBundle\Entity\TipoServicio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sisconee\\AppBundle\\Entity\\TipoServicio' . "\0" . 'id', '' . "\0" . 'sisconee\\AppBundle\\Entity\\TipoServicio' . "\0" . 'descripcion', '' . "\0" . 'sisconee\\AppBundle\\Entity\\TipoServicio' . "\0" . 'activo', 'servicios');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoServicio $proxy) {
