 ...
 */
class Organismo extends \sisconee\AppBundle\Entity\Organismo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Organismo' . "\0" . 'id', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Organismo' . "\0" . 'codigo', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Organismo' . "\0" . 'nombre', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Organismo' . "\0" . 'siglas', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Organismo' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Organismo $proxy) {
