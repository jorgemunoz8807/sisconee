 ...
 */
class Municipio extends \sisconee\AppBundle\Entity\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Municipio' . "\0" . 'id', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Municipio' . "\0" . 'codigo', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Municipio' . "\0" . 'descripcion', 'provincia');
        }
