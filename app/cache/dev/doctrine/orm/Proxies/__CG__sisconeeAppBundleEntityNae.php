 ...
 */
class Nae extends \sisconee\AppBundle\Entity\Nae implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Nae' . "\0" . 'id', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Nae' . "\0" . 'codigo', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Nae' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Nae $proxy) {
