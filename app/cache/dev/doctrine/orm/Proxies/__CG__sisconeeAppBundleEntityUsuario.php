 ...
 */
class Usuario extends \sisconee\AppBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'username', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'correo', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'activo', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'entidad', '' . "\0" . 'sisconee\\AppBundle\\Entity\\Usuario' . "\0" . 'rol');
        }
