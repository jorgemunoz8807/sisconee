...
class __TwigTemplate_a69300e8fd5d399d5e836c78395a33c790fbba22d579650f7671ddd3b1ef7814 extends Twig_Template
{
    ...
    ";
        // line 10
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : $this->getContext($context, "edit_form")), "oldPass"), 'row');
        echo "
    ";
        // line 11
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : $this->getContext($context, "edit_form")), "newPass"), 'row');
        echo "
...
";
    ...
    {
        return "sisconeeAdministracionBundle:Usuario:commonUserEditPass.html.twig";
    }
    ...
    {
        return array (  92 => 30,  88 => 29,  83 => 28,  80 => 27,  74 => 24,  69 => 22,  62 => 18,  57 => 16,  49 => 11,  45 => 10,  40 => 8,  35 => 5,  32 => 4,  29 => 3,);
    }
}
