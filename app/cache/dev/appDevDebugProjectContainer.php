...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'filterservice' => 'getFilterserviceService',
            ...
            'orderbyservice' => 'getOrderbyserviceService',
            'pagerservice' => 'getPagerserviceService',
            'prefixedsessionservice' => 'getPrefixedsessionserviceService',
            ...
            'security.firewall.map.context.general' => 'getSecurity_Firewall_Map_Context_GeneralService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/sisconee/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/sisconee/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/sisconee/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/sisconee/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3307, 'dbname' => 'sisconee', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_d8e3dc32b5dc56937da38e6c03b1aa8412f4663a3a32249036d3fa789b7ac5b3');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d8e3dc32b5dc56937da38e6c03b1aa8412f4663a3a32249036d3fa789b7ac5b3');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d8e3dc32b5dc56937da38e6c03b1aa8412f4663a3a32249036d3fa789b7ac5b3');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\sisconee\\src\\sisconee\\AppBundle\\Entity')), 'sisconee\\AppBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('sisconeeAppBundle' => 'sisconee\\AppBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/wamp/www/sisconee/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/sisconee/app/Resources');
    }
    ...
    /**
     * Gets the 'filterservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sisconee\SessionServicesBundle\Controller\SessionFilterService A sisconee\SessionServicesBundle\Controller\SessionFilterService instance.
     */
    protected function getFilterserviceService()
    {
        return $this->services['filterservice'] = new \sisconee\SessionServicesBundle\Controller\SessionFilterService($this->get('prefixedsessionservice'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/sisconee/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'orderbyservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sisconee\SessionServicesBundle\Controller\SessionOrderByService A sisconee\SessionServicesBundle\Controller\SessionOrderByService instance.
     */
    protected function getOrderbyserviceService()
    {
        return $this->services['orderbyservice'] = new \sisconee\SessionServicesBundle\Controller\SessionOrderByService($this->get('prefixedsessionservice'));
    }

    /**
     * Gets the 'pagerservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sisconee\SessionServicesBundle\Controller\SessionPagerService A sisconee\SessionServicesBundle\Controller\SessionPagerService instance.
     */
    protected function getPagerserviceService()
    {
        return $this->services['pagerservice'] = new \sisconee\SessionServicesBundle\Controller\SessionPagerService($this->get('prefixedsessionservice'), 8);
    }

    /**
     * Gets the 'prefixedsessionservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sisconee\SessionServicesBundle\Controller\PrefixedSessionService A sisconee\SessionServicesBundle\Controller\PrefixedSessionService instance.
     */
    protected function getPrefixedsessionserviceService()
    {
        return $this->services['prefixedsessionservice'] = new \sisconee\SessionServicesBundle\Controller\PrefixedSessionService($this->get('session'));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/sisconee/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/sisconee/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/sisconee/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('sisconee\\AppBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.general' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/sisconee/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/sisconee/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/sisconee/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('jorgem');
        $a->setPassword('Jamchyoyo88');
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/sisconee/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('general', '/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/sisconee/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/sisconee/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/sisconee/app', 'UTF-8'));
        ...
        $instance->addGlobal('roles', array('ROLE_PLANIFICADOR_SUP' => 'Planificador Superior', 'ROLE_PLANIFICADOR_ENT' => 'Planificador Entidad', 'ROLE_PLANIFICADOR_SER' => 'Planificador Servicio', 'ROLE_REGISTRADOR_SER' => 'Registrador Servicio', 'ROLE_SUPERVISOR_SUP' => 'Supervisor Superior', 'ROLE_SUPERVISOR_ENT' => 'Supervisor Entidad', 'ROLE_ADMIN' => 'Administrador del sistema'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\sisconee\\src\\sisconee\\AppBundle/Resources/views', 'sisconeeApp');
        $instance->addPath('C:\\wamp\\www\\sisconee\\src\\sisconee\\AdministracionBundle/Resources/views', 'sisconeeAdministracion');
        $instance->addPath('C:\\wamp\\www\\sisconee\\src\\sisconee\\SessionServicesBundle/Resources/views', 'sisconeeSessionServices');
        $instance->addPath('C:\\wamp\\www\\sisconee\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/sisconee/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\sisconee\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\wamp\\www\\sisconee\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/sisconee/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/sisconee/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.usuarios'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'sisconee\\AppBundle\\Entity\\Usuario', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/sisconee/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/sisconee/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/sisconee/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/sisconee/app/logs',
            'kernel.bundles' => array(
                ...
                'sisconeeAppBundle' => 'sisconee\\AppBundle\\sisconeeAppBundle',
                'sisconeeAdministracionBundle' => 'sisconee\\AdministracionBundle\\sisconeeAdministracionBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'sisconeeSessionServicesBundle' => 'sisconee\\SessionServicesBundle\\sisconeeSessionServicesBundle',
            ...
            'database_port' => 3307,
            'database_name' => 'sisconee',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.citmatel.inf.cu',
            'mailer_user' => 'jorgem',
            'mailer_password' => 'Jamchyoyo88',
            'locale' => 'en',
            ...
            'debug.container.dump' => 'C:/wamp/www/sisconee/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/sisconee/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/sisconee/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/sisconee/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/sisconee/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'jorgem',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Jamchyoyo88',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => NULL,
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/sisconee/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/sisconee/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/sisconee/app/../web',
            'assetic.write_to' => 'C:/wamp/www/sisconee/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/sisconee/app/cache/dev/doctrine/orm/Proxies',
